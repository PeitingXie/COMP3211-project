...
begin
    ...
    begin
        if (reset = '1') then
              ...
              var_insn_mem(38)  := X"79000001"; --srr $1, $9, $0
              var_insn_mem(39)  := X"61000001"; --slr $1, $1, $0       get bits left from p1 + s, shift to right position, store in $1 
              ...
              var_insn_mem(42)  := X"6F800002"; --sll $2, $15, $8 shift left
              ...
              var_insn_mem(47)  := X"8de00000"; --add $0, $13, $14
              var_insn_mem(48)  := X"79000001"; --SRL $1, $9, $0
              var_insn_mem(49)  := X"61000001"; --sll $1, $1, $0      get bits left from p2 + s, shift to right position, store in $1 
              var_insn_mem(50)  := X"1d000000"; --lw $0, $13, 0
              var_insn_mem(51)  := X"99000000"; --and $0, $9, $0
              var_insn_mem(52)  := X"6bd00002"; --sll $2, $11, $13
              ...
              var_insn_mem(58)  := X"75100001"; --srr $1, $5, $1
              ...
              var_insn_mem(65)  := X"75100001"; --srr $1, $5, $1
              ...
              -------- tag generated
              var_insn_mem(89)  := X"B0400001";--beq $0, $4, 1
              var_insn_mem(90)  := X"B0000064";--beq $0, $0, 100
              var_insn_mem(91)  := X"1a000005";--lw $0, $10, 5    get 0b11111, used for get district number, store in $0
              var_insn_mem(92)  := X"1a100067";--lw $1, $10, 103     get 3, store in $1
              var_insn_mem(93)  := X"1a200018";--lw $2, $10, 24      get unchanged D0
              var_insn_mem(94)  := X"7210000d";--lsr $13, $2, $1
              var_insn_mem(95)  := X"9d00000d";--and $13, #13, $0     get district number, store in $13
              
              var_insn_mem(96)  := X"1a000003";--lw $0, $10, 3       get 0b111, store in $0
              var_insn_mem(97)  := X"92000003";--and $3, $2, $0      get last three bits in D0, store in $3
              var_insn_mem(98)  := X"1a200019";--lw $2, $10, 25      get unchanged D1, store in $2
              var_insn_mem(99)  := X"1a000001";--lw $0, 10, 1        get 1, store in $0
              var_insn_mem(100)  := X"1a10006b";--lw $1, $10, 107     get 7, store in $1
              var_insn_mem(101)  := X"72100004";--lsr $4, $2, $1
              var_insn_mem(102)  := X"94000004";--and $4, $4, $0      get first bit in D1, store in $4
              var_insn_mem(103)  := X"63000003";--srl $3, $3, $0
              var_insn_mem(104)  := X"8340000E";--add $14, $3, $4     store candicate number in $14 
              var_insn_mem(105)  := X"1a000007";--lw $0, $10, 7
              var_insn_mem(106)  := X"92000000";--and $0, $2, $0
              var_insn_mem(107)  := X"1a10001a";--lw $1, $10, 26      D2 all bits, store in $1
              var_insn_mem(108)  := X"1a20001b";--lw $2, $10, 27      D3 all bits, store in $2
              var_insn_mem(109)  := X"1a300074";--lw $3, $10, 116     get 16, store in $3
              var_insn_mem(110)  := X"c0300000";--sr $0, $0, $3
              var_insn_mem(111)  := X"1a40006c";--lw $4, $10, 108
              var_insn_mem(112)  := X"c1400001";--sr $1, $1, $4
              var_insn_mem(113)  := X"8010000F";--add $15, $0, $1
              var_insn_mem(114)  := X"8F20000F";--add $15, $15, $2
              var_insn_mem(115)  := X"1a00000c";--lw $0, $10, 12
              var_insn_mem(116)  := X"00000000";
              var_insn_mem(117)  := X"00000000";
              var_insn_mem(118)  := X"B0E00002";--beq $0, $14, 2          if same candicate        
              var_insn_mem(119)  := X"B000000D";--beq $0, $0, 11          if not same candicate,
              var_insn_mem(120)  := X"00000000";
              var_insn_mem(121)  := X"00000000";
              var_insn_mem(122)  := X"1a00000D";--lw $0, $10, 13
              var_insn_mem(123)  := X"1a10000E";--lw $1, $10, 14
              var_insn_mem(124)  := X"81F00001";--add $1, $1, $15         update total votes
              var_insn_mem(125)  := X"3a10000E";--sw $1, $10, 14          set new total votes to data memory 14
             
              var_insn_mem(126)  := X"1a900065";-- lw $9, $10, 101
              var_insn_mem(127)  := X"80900000";--add $0, $0, $9       add position by 1
              var_insn_mem(128)  := X"30F00000";--sw $15, $0, 0           store votes for this district
              var_insn_mem(129)  := X"3a00000D";--sw $0, $10, 13          store next position back
              var_insn_mem(130)  := X"b000001e";--beq $0, $0, 30        to be changed
              var_insn_mem(131)  := X"00000000";
              var_insn_mem(132)  := X"00000000";
              var_insn_mem(133)  := X"1a00000d";--lw $0, $10, 13      get next position, store in $0
              var_insn_mem(134)  := X"1a10000e";--lw $1, $10, 14      get total votes for last candicate, store in $1
              var_insn_mem(135)  := X"1a900065";-- lw $9, $10, 101
              var_insn_mem(136)  := X"80900000";--add $0, $0, $9       add position by 1
              var_insn_mem(137)  := X"30100000";--sw $1, $0, 0        store total count
              var_insn_mem(138)  := X"80900000";--add $0, $0, $9       add position by 1
              var_insn_mem(139)  := X"3aF0000e";--sw $15,$10, 14
              var_insn_mem(140)  := X"1a80000b";----lw $8, $10, 11
              var_insn_mem(141)  := X"30800000";----sw $8, $0, 0
              var_insn_mem(142)  := X"80900000";--add $0, $0, $9       add position by 1
              
              
              var_insn_mem(143)  := X"30E00000";--sw $14, $0, 0       store new candicate name
              var_insn_mem(144)  := X"3aE0000C";--sw $14, $10, 12     update curr candicate number
              var_insn_mem(145)  := X"3aF0000E";--sw $15, $10, 14
              var_insn_mem(146)  := X"80900000";--add $0, $0, $9       add position by 1
              var_insn_mem(147)  := X"30F00000";--sw $15, $0, 0
              var_insn_mem(148)  := X"3a00000D";--sw $0, $10, 13          store next position back
              -- Put mips code here
              i := 149;
              while i <= 1023 loop
